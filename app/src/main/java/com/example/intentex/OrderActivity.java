...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewResult = (TextView) findViewById(R.id.textView_resultOrder);
        ...
        buttonCancel = (Button) findViewById(R.id.button_cancelOrder);
        buttonOK = (Button) findViewById(R.id.button_okOrder);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.button_okOrder:
                    ...
                    textViewResult.append("The total fee = " + sum + " 元");
                    Log.d(TAG, "sum = " + sum);

                    orderResult = textViewResult.getText().toString();

                    Intent intent = new Intent();
                    intent.putExtra("orderResult", orderResult);
                    setResult(ReturnOrderCode, intent);
    ...
    private void showDialog_1() {
        ...
        builder.setMessage(orderResult);
